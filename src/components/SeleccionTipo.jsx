    ...
    <>
      ...
      <div className="fondo-bienvenida">
        <div className="formulario-container" style={{ textAlign: "center" }}>
          <h1 style={{ marginBottom: "0.5rem", fontSize: "3rem", color: "#1a4381" }}>
            ¡Bienvenido al SPAFE!
          </h1>
          <h2 style={{ marginBottom: "1rem", fontSize: "1.5rem", color: "#1a4381" }}>
            Sistema semiautomatizado de cálculos de PAFE
          </h2>
